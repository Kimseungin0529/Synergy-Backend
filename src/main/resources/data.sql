...
-- 부스
INSERT INTO booth (conference_id, company_name, company_type, booth_location, booth_number, booth_description, image_key, image_url, qr_key, qr_url, secret_code, progress_date)
VALUES (1, 'CodeSphere', 'YourCompanyType', 'C HALL', '101C', '클라우드서비스: 글로벌 IT 기업 CodeSphere에서 React 기반 프론트엔드 엔지니어와 클라우드 기반 백엔드 엔지니어를 채용합니다. TypeScript, Node.js, Kubernetes 경험자를 환영합니다.', 'default-key', 'https://default-image-url.com/default.jpg', 'default-qr-key', 'https://default-qr-url.com/default-qr.png', 'default-secret-code', '2025-09-15');
